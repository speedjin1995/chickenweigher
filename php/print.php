                                    ...
                                    <td style="width: 50%;border-top:0px;">
                                        ...
                                        <table class="table" style="width: 95%">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="width: 40%;border-top:0px;padding: 0 0.7rem;">Birds</td>
                                        ...
                                        <table class="table" style="width: 95%">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <th style="width: 20%;border-top:0px;padding: 0 0.7rem;border: 1px solid #000000;font-size: 12px;">Nett(kg)</th>
                                                    <th style="width: 22%;border-top:0px;padding: 0 0.7rem;border: 1px solid #000000;">Average</th>
                                                </tr>';
                                                ...
                                                for($j=0; $j<count($mapOfHouses); $j++){
                                                    ...
                                                    $message .= '<tr>
                                                        ...
                                                        <td style="width: 20%;border-top:0px;padding: 0 0.7rem;border: 1px solid #000000;">'.$crateIn.'</td>
                                                        <td style="width: 20%;border-top:0px;padding: 0 0.7rem;border: 1px solid #000000;">'.$birdsIn.'</td>
                                                        <td style="width: 20%;border-top:0px;padding: 0 0.7rem;border: 1px solid #000000;">'.$nettsIn.'</td>
                                                        <td style="width: 22%;border-top:0px;padding: 0 0.7rem;border: 1px solid #000000;">'.number_format($average, 2, '.', '').'</td>
                                                    </tr>';
                                                }
