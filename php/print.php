...
function rearrangeList($weightDetails) {
    global $mapOfHouses, $mapOfWeights, $mapOfBirdsToCages, $totalSGross, $totalSCrate, $totalSReduce, $totalSNet, $totalSBirds, $totalSCages, $totalAGross, $totalACrate, $totalAReduce, $totalANet, $totalABirds, $totalACages, $totalGross, $totalCrate, $totalReduce, $totalNet, $totalCrates, $totalBirds, $totalMaleBirds, $totalMaleCages, $totalFemaleBirds, $totalFemaleCages, $totalMixedBirds, $totalMixedCages, $gradeData;
                                                            ...
                                                            <tbody>
                                                                ...
                                                                if (isset($group['houses']) && is_array($group['houses'])) {
                                                                    foreach ($group['houses'] as $house) {
                                                                        ...
                                                                        $message .= '<tr>
                                                                            <td style="width: 28%;border-top:0px;padding: 0 0.7rem;font-size: '.$fontSize.';font-family: sans-serif;font-weight: bold;text-align: center;">'.$houseNumber.'</td>
                                                                            ...
                                                                            <td style="width: 22%;border-top:0px;padding: 0 0.7rem;border: 1px solid #000000;font-size: '.$fontSize.';font-family: sans-serif;text-align: center;">'.number_format($houseAverage, 2, '.', '').'</td>
                                                                        </tr>';
                                                                    }
                                                                }
