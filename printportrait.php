                                                ...
                                                <td colspan="3">
                                                    <table class="table-full" style="width: 50%;">
                                                        <tbody>
                                                            ...
                                                            $message .= '<td style="text-align: center;font-size: 12px;"><b>'.$totalMale.'</b></td>';
                                                            $message .= '<td style="text-align: center;font-size: 12px;"><b>'.$totalFemale.'</b></td>';
                                                            $message .= '<td style="text-align: center;font-size: 12px;"><b>'.$totalMixed.'</b></td>';
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="width: 50%;border-top:0px;padding: 0 0.7rem;">
                                                        <p>
                                                            <span style="font-size: 14px;font-family: sans-serif;font-weight: bold;">Group : </span>
                                                            <span style="font-size: 14px;font-family: sans-serif;font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . $groupNumber . ' of ' . count($mapOfWeights) . '</span>
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
